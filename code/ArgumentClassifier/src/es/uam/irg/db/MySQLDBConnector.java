...
public class MySQLDBConnector extends DBConnector {
    ...
    // ===========================
    /**
     * Acquires a connection to a database with the given user name and user password
     *
     * @param dbServer the URL of the database server in which the connection is going to be established
     * @param dbName the name of the database in which the connection is going to be established
     * @param userName the name of the user who wants to open the connection
     * @param userPassword the password of the user who wants to open the connection
     * 
     * @throws java.lang.Exception
     */
